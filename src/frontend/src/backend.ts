...
import type { CaseId as _CaseId, CaseStatus as _CaseStatus, ConflictCase as _ConflictCase, UserId as _UserId, UserProfile as _UserProfile, UserRole as _UserRole, Verdict as _Verdict } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async analyzeCase(arg0: CaseId): Promise<Verdict> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeCase(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async analyzeCaseAnonymous(arg0: string, arg1: string | null): Promise<Verdict> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzeCaseAnonymous(arg0, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserCases(): Promise<Array<[ConflictCase, Verdict | null]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserCases();
    ...
    async submitCase(arg0: string, arg1: string, arg2: string | null): Promise<CaseId> {
        if (this.processError) {
            try {
                const result = await this.actor.submitCase(arg0, arg1, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CaseStatus_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CaseStatus): CaseStatus {
    return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function from_candid_ConflictCase_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ConflictCase): ConflictCase {
...
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Verdict]): Verdict | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_CaseStatus_n11(_uploadFile, _downloadFile, value.status),
        title: value.title,
        owner: value.owner,
        description: value.description,
        timestamp: value.timestamp,
        otherPartyDescription: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.otherPartyDescription))
    };
}
function from_candid_tuple_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [_ConflictCase, [] | [_Verdict]]): [ConflictCase, Verdict | null] {
    return [
        from_candid_ConflictCase_n9(_uploadFile, _downloadFile, value[0]),
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? CaseStatus.pending : "analyzed" in value ? CaseStatus.analyzed : value;
}
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[_ConflictCase, [] | [_Verdict]]>): Array<[ConflictCase, Verdict | null]> {
